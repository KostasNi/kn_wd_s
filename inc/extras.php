 ...
 * @return array
 */
function _kn_wd_s_body_classes( $classes ) {
...
add_filter( 'body_class', '_kn_wd_s_body_classes' );
 ...
 */
function _kn_wd_s_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', '_kn_wd_s_content_image_sizes_attr', 10 , 2 );
 ...
 */
function _kn_wd_s_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', '_kn_wd_s_post_thumbnail_sizes_attr', 10 , 3 );
